...
public class Deck
{
	...
	*/
	...
	public String top()  //take card on top of deck
	{ 
		return this.theDeck[0];
	}
	
	public int length() //return length of the deck
	{
		int len = 0;
		for (int i = 0; i < this.theDeck.length; i++)
		{
	...
	public boolean isEmpty() //to check if deck is empty
	{
	...
	public Card get(int position) //retrieve a card from specified position
	{
