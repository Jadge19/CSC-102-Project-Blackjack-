...
public class Hand
{
	...
	public boolean bothEqual(Hand otherHand) //to see if two hand are equally valued
	{
	...
	public boolean doubleAce() //to check if a hand is two ace value cards
	{
	...
	public boolean doubleTen() //to check if a hand is two ten value cards
	{
		if ((this.Hand.get(0).getValue() == 10) && (this.Hand.get(1).getValue() == 10))
		{
			return true;
		}
		else
